...
export declare class AggregationCursor<
    TSchema = any,
> extends ExplainableCursor<TSchema> {
 ...
 * @public
 */
export declare type AnyClientBulkWriteModel<TSchema extends Document> =
 ...
 *
 */
export declare type ClientBulkWriteModel<
...
/** @public */
export declare interface ClientDeleteManyModel<
    TSchema,
...
/** @public */
export declare interface ClientDeleteOneModel<
    TSchema,
> extends ClientWriteModel {
    name: "deleteOne"
    /**
...
/** @public */
export declare interface ClientInsertOneModel<
    TSchema,
> extends ClientWriteModel {
    name: "insertOne"
...
/** @public */
export declare interface ClientReplaceOneModel<
    TSchema,
> extends ClientWriteModel {
    name: "replaceOne"
    /**
...
/** @public */
export declare interface ClientUpdateManyModel<
    TSchema,
> extends ClientWriteModel {
    name: "updateMany"
    /**
...
/** @public */
export declare interface ClientUpdateOneModel<
    TSchema,
> extends ClientWriteModel {
    name: "updateOne"
    /**
...
/** @public */
export declare interface CreateCollectionOptions extends Omit<
    CommandOperationOptions,
    "rawData"
> {
 ...
 * @experimental
 */
export declare type CursorTimeoutMode =
    (typeof CursorTimeoutMode)[keyof typeof CursorTimeoutMode]
...
/** @public */
export declare interface DbStatsOptions extends Omit<
    CommandOperationOptions,
    "rawData"
> {
...
/** @public */
export declare interface DropCollectionOptions extends Omit<
    CommandOperationOptions,
    "rawData"
> {
    /** @experimental */
 ...
 */
export declare abstract class ExplainableCursor<
    TSchema,
...
/** @public */
export declare type FindOneOptions = Omit<
    FindOptions,
    "batchSize" | "limit" | "noCursorTimeout"
>
...
export declare interface FindOptions
    extends
        Omit<CommandOperationOptions, "writeConcern" | "explain">,
...
/** @public */
export declare type IndexDescriptionCompact = Record<
    string,
 ...
 */
export declare type IndexDescriptionInfo = Omit<
    IndexDescription,
    "key" | "version"
> & {
    key: {
...
/** @public */
export declare interface ListDatabasesOptions extends Omit<
    CommandOperationOptions,
    "rawData"
> {
...
/** @public */
export declare type ListSearchIndexesOptions = Omit<
    AggregateOptions,
...
export declare class MongoClient
    extends TypedEventEmitter<MongoClientEvents>
    implements AsyncDisposable
{
    /* Excluded from this release type: s */
    ...
    readonly options: Readonly<
        Omit<
            MongoOptions,
            "monitorCommands" | "ca" | "crl" | "key" | "cert" | "driverInfo"
        >
    > &
        Pick<
            MongoOptions,
...
/** @public */
export declare type MongoLoggableComponent =
 ...
 * @public
 */
export declare type OIDCCallbackFunction = (
...
/** @public */
export declare type ProfilingLevelOptions = Omit<
    CommandOperationOptions,
    "rawData"
>
...
/** @public */
export declare interface RenameOptions extends Omit<
    CommandOperationOptions,
    "rawData"
> {
...
/** @public */
export declare type ServerMonitoringMode =
    (typeof ServerMonitoringMode)[keyof typeof ServerMonitoringMode]
...
/** @public */
export declare type SetProfilingLevelOptions = Omit<
    CommandOperationOptions,
    "rawData"
>
...
/** @public */
export declare type SeverityLevel =
...
/** @public */
export declare type SortDirectionForCmd =
    | 1
    | -1
    | {
          $meta: string
...
export declare class StreamDescription {
    ...
    parseServerConnectionID(
        serverConnectionId: number | Double | bigint | Long,
    ): bigint
}
 ...
 * @public
 */
export declare interface TransactionOptions extends Omit<
    CommandOperationOptions,
    "timeoutMS"
> {
...
/** @public */
export declare interface ValidateCollectionOptions extends Omit<
    CommandOperationOptions,
    "rawData"
> {
...
/** @public */
export declare type WithSessionCallback<T = unknown> = (
    session: ClientSession,
) => Promise<T>

/** @public */
export declare type WithTransactionCallback<T = any> = (
    session: ClientSession,
) => Promise<T>
